 ...
 * Use the [ProviderDashboardFragment.newInstance] factory method to
...
class ProviderDashboardFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ProviderDashboardFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ProviderDashboardFragment().apply {
